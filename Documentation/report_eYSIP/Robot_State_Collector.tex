...
\section{Abstract}
t
\hspace{5mm}This project aims at developing a State Collection Algorithm which is easy to integrate with user code without interfering with it. Our code should be capable of collecting the sensor values and even the buzzer and LCD data periodically. It should also send this data to the GUI developed for this specific purpose. The GUI should be able to encrypt the collected data and send it to the e-Yantra servers.
...
\begin{enumerate}
    ...
    \item Writing server side code to receive and decrypt the state information obtained from GUI developed in step 3.
...
\begin{enumerate}
    ...
    \item Successfully collected the data on Fire Bird V and Tiva bot using the specially developed State Collection Algorithm.
