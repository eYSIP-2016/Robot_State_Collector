/*********************************************************************************************************************
* Objective :  Implementing serial communication via USB.
* Description:Through this program we are storing the value of 1 sharp sensor after every 1 second and sending 
              it to laptop via USB serial communication.
...
char a[3]={48};
int store[10];  
int count = 0;     //variable which keeps track of how many time data is stored.
...
void init_devices (void)
{
 ...
 uart2_init();
 timer4_init();
 TIMSK4 = 0x01;   //timer 4 interrupt enable
...
int main()
{
	...
	while (count <= 6 )
    {
		//printing of stored value on lcd after count value is reached 6.
